       ...
       if(userPosition == "prof"){
            if(pub < 50 || pub > 65 ){
                ...
                if(teach < 15 || teach > 20){
                    alert("Teaching experince score can't be less than 15 or greater than 20") 
                }else{
                    score = score + teach

                    if(conf < 5 || conf > 10 ){
                        alert("Conference score can't be less than 5 or greater than 10") 
                    }else{
                        score = score + conf
        ...
        if(pub < 45 || pub > 60 ){
            ...
            if(teach < 15 || teach > 25){
                alert("Teaching experince score can't be less than 15 or greater than 25") 
            }else{
                score = score + teach
            ...
            if(quan > 10){
                ...
                if(pub < 15 || pub > 40 ){
                    alert("Publication score can't be less than 15 or greater than 40")
                }else{
                    score = score + pub
                    
                    if(teach < 15 || teach > 35){
                        alert("Teaching experince score can't be less than 15 or greater than 35") 
                    }else{
                        score = score + teach
        ...
        if(quan > 35){
            ...
            if(pub < 7 || pub > 25 ){
                alert("Publication score can't be less than 7 or greater than 25")
            }else{
                score = score + pub
                
                if(teach < 10 || teach > 25){
                    alert("Teaching experince score can't be less than 10 or greater than 25") 
                }else{
                    score = score + teach
    
                    if(conf < 2 || conf > 10 ){
                        alert("Conference score can't be less than 2 or greater than 10") 
                    }else{
                        score = score + conf
                    ...
                    {imageList.slice(0, 1).map((url) =>{
                        return( 
                            <div>
                                ...
                                <input type="number" name="" id="quan" placeholder='Enter Appraisal score'/>
                            </div>
                        )
                    })}
                </div>
                ...
                <div>
                    ...
                    {imageList.slice(1, 2).map((url) =>{
                        return( 
                            <div>
                                <img src={url} className='img-fluld' alt=''/>
                                <input type="number" name="" id="pub" placeholder='Enter Appraisal score'/>
                            </div>
                        )
                    })}
                </div>
                ...
                <div>
                    ...
                    {imageList.slice(2, 3).map((url) =>{
                        return( 
                            <div>
                                <img src={url} className='img-fluld' alt=''/>
                                <input type="number" name="" id="teach" placeholder='Enter Appraisal score'/>
                            </div>
                        )
                    })}
                </div>
                ...
                <div>
                    ...
                    {imageList.slice(3, 4).map((url) =>{
                        return( 
                            <div>
                                <img src={url} className='img-fluld' alt=''/>
                                <input type="number" name="" id="conf" placeholder='Enter Appraisal score'/>
                            </div>
                        )
                    })}
                </div>
                ...
                <div>
                    ...
                    {imageList.slice(4, 5).map((url) =>{
                        return( 
                            <div>
                                <img src={url} className='img-fluld' alt=''/>
                                <input type="number" name="" id="admin" placeholder='Enter Appraisal score'/>
                            </div>
                        )
                    })}
                </div>
            
              <button className='butto' onClick={handleAppraise}>Appraise</button>
            </div>
            <div className="col-lg-2"></div>
        </div>
