    ...
    const UploadDocument = () => {
      ...
      console.log(reviewID)
        ...
        uploadBytes(imageRef5, docUpload5).then(() =>{
          addDoc(Appraisal_Process, {userID: userId, reviewID: reviewID, appraisal_score: 0, status: "open", qualification: docUpload1.name, publication: docUpload2.name, teaching: docUpload3.name, conferences: docUpload4.name, admin_exp: docUpload5.name})
    ...
    <div className='container'>
        ...
        <div className="form">
            <h2>Upload Documents</h2>
              ...
              <div className='form-group'>
                  <label for="mn" className='text-bold'>Publication & Creative Work</label>
                  <input 
                    className="form__field" 
                    id="mn" 
                    type="file" 
              ...
              <div className='form-group'>
                  <label for="ln" className='text-bold'>Teaching Experince</label>
                  <input 
                    className="form__field" 
                    id="ln" 
                    type="file" 
              ...
              <div className='form-group'>
                  <label for="email" className='text-bold'>Conferences</label>
                  <input 
                    className="form__field" 
                    id="email" 
                    type="file" 
              ...
              <div className='form-group'>
                  <label for="password" className='text-bold'>Admin Experience</label>
                  <input 
                    type="file" 
                    className="form__field" 
              ...
              <div className='form-group'>
                  <button className="form__submit" type="submit" onClick={UploadDocument}>Submit Appraisal Request	</button>
              </div>
