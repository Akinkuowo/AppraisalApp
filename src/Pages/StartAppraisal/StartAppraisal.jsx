        ...
        <div className="container">
            <div className="row">
                    ...
                    appraisal.map((appraise) => {
                      if(appraise.status == "open"){
                        return ( 
                                ...
                                <option value={appraise.userIDID} >{appraise.userID} {`(Review ID: ${appraise.reviewID})`}</option>
                    ...
                    appraisal.map((appraise) => {
                      if(appraise.status == "open"){
                        return ( 
                              ...
                              <option value={appraise.reviewID} >{appraise.reviewID}</option>
                ...
                <div className="col-lg-4 mt-4">
                    <button className='button' onClick={viewDoc}>View Document</button>
                </div>
            </div>
        </div>
        <div>
